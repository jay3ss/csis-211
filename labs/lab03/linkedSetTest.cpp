/** @file: linkedSetTest.cpp
 *  Driver to test the LinkedSet class
 */
#include <iostream>
#include <string>
#include <vector>
...
int main()
{
    ...
    cout << "Check if an empty set is a subset of another set:\n"
         << "-------------------------------------------------\n\n";
    LinkedSet<int> empty;

    cout << "isSebset(empty): returns " << intLS.isSubset(empty)
         << "; should return 1 (true)";
